...
c.MarkdownExporter.template_path = ['/Users/aukauk/.ipython/templates'] # point this to your jekyll template file
...
if f:
    ...
    c.FilesWriter.build_directory = '/Users/aukauk/Desktop/Jinju/Portfolio/myblog/notebooks' # point this to your build directory
